...
<section id="section-Hero" className="bg-[url('/images/interiore27.jpg')] bg-contain bg-no-repeat full flex-col items-center lg:bg-[url('/images/interiore13.jpg')] lg:bg-cover lg:bg-no-repea ">
      ...
      <div className="  flex min-h-screen flex-col items-center">
        ...
        <h1 className="aligncontent -mb-3 font-bowlbySC relative top-[3vh] text-[7.0rem] uppercase leading-3 text-[#d3d355] headingC sm:text-8xl md:text-[12rem] md:top-3 lg:text-[15.33rem]  xl:text-[13rem] xl:top-8">
          {t("Title")}
        </h1>
        </div>
